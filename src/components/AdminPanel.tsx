...
import { Product, Order, PromoPackage, Topping } from '../types';
...
export default function AdminPanel({
  ...
  const [activeAdminTab, setActiveAdminTab] = useState<'pesanan' | 'produk' | 'promo'>('pesanan');
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-stone-50/50">
                          ...
                          <button
                            onClick={() => {
                              ...
                              try {
                                ...
                                confirmed = true; // Fallback to delete if blocked by sandbox
                              }
                              if (confirmed) {
          ...
          {activeAdminTab === 'promo' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {promos.map((p) => (
                  <div key={p.id} className="bg-white rounded-2xl p-4 border border-stone-150 space-y-3">
